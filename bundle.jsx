    ...
    <div className="kor">
      ...
      <div className="kor__grid">
        ...
        <div className="kor__left">
          ...
          <p className="kor__p">
            일반적으로 '비만 = 당뇨병 위험 증가'라는 공식이 통하지만, 한국과 일본은 이 공식에서 벗어난 예외적인 특성을 보입니다. 2023년 OECD 보고서 기준 평균과 비교해 보면, 한국의 비만율은 최저 수준이지만 당뇨병 유병률은 OECD 평균에 거의 근접해 있습니다. 이는 겉으로 보기엔 건강해 보여도, 실제로는 당뇨병 위험이 잠재되어 있을 수 있다는 점을 경고합니다.
          </p>
          <OECDScatter />
        </div>
